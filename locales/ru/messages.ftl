...
donate-message = 
    ...
    Поддержите проект и помоги ему развиваться!
    Донат помогает поддерживать и улучшать бота.
    
    <tg-emoji emoji-id="5258204546391351475">💰</tg-emoji> <a href="https://t.me/send?start=IV33ltNgzUFL">Пожертвовать через CryptoBot</a>
    
    <tg-emoji emoji-id="5260268501515377807">📣</tg-emoji> <b>Если хотите, подписывайтесь на <a href="https://t.me/id2757542991">мой канал</a> — там обновления и другие интересные проекты.</b>
